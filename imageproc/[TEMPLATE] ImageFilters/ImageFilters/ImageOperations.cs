...
namespace ImageFilters
{
    public class ImageOperations
    {
        ...
        {
            const int T = 3;
            const int indoSize = 2; // 1 -> 3x3, 2-> 5x5, 3-> 7x7
            ...
            for (int i = 0; i < ImageMatrix.GetLength(0); i++)
            {
                for (int j = 0; j < ImageMatrix.GetLength(1); j++)
                {
                    ...
                    int neighboursSum = 0;
                    for (int ineighbours = -1 * indoSize; ineighbours <= indoSize; ++ineighbours)
                    {
                        for (int jneighbours = -1 * indoSize; jneighbours <= indoSize; ++jneighbours)
                        {
